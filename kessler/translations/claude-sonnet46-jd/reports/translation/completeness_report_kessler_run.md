...
| | |
|---|---|
| run | 2026-09-03T10:07:05.944854 |
| scope | procedure kessler_run |
| verdict | **PASS** — PASS 1, WARN 0, FAIL 0, MISSING 0 |
...
|---|---|---|---|---|---|
| kessler_run | 173 | 216 | 1.249 | PASS |  |

Machine-readable: `out/reports/translation/completeness_check_kessler_run.json`
